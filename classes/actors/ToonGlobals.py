...
JOINT_HIPS = "joint_hips"
JOINT_HEAD = "def_head"
TORSO_TOP = "torso-top"
TORSO_BOTTOM = "torso-bot"
SLEEVES = "sleeves"
SHORTS = "shorts"
SKIRT = "skirt"
NECK = "neck"
...
ANIMS = {
    '3': ['neutral', 'run'],
    '3.5': ['angry', 'book', 'conked', 'cringe', 'duck',
            'jump', 'jump-back-right', 'jump-z', 'jump-zend', 'jump-zhang',
            'jump-zstart', 'pie-throw', 'press-button', 'running-jump',
            'shrug', 'sidestep-left', 'teleport',
            'victory-dance', 'walk', 'wave', 'leap_zend'],
    '4': ['applause', 'begCycle', 'begOut', 'bored', 'bow',
          'cast', 'castlong', 'confused', 'down', 'eat_neutral',
          'eatnrun', 'fish', 'fishAGAIN', 'fishEND', 'fishneutral',
          'gameneutral', 'gamerun', 'gameThrow', 'give',
          'intoBeg', 'intoSit', 'left', 'losewalk',
          'petend', 'petin', 'petloop', 'pole', 'poleneutral',
          'reel', 'reelH', 'reelneutral', 'right',
          'sad-neutral', 'scientistGame', 'scientistJealous', 'scientistWork',
          'sit', 'slip-backward', 'slip-forward', 'swim', 'swing', 'surprise',
          'taunt', 'think', 'tug-o-war', 'up'],
    '5': ['climb', 'happy-dance', 'hold-bottle', 'hold-magnet', 'hypnotize',
          'juggle', 'lose', 'shout', 'smooch', 'spit', 'struggle',
          'toss', 'water-gun', 'tickle', 'melt'],
    '5.5': ['callPet', 'feedPet', 'into_dig', 'loop_dig', 'water',
            'takePhone', 'phoneNeutral', 'phoneBack'],
    '6': ['good-putt', 'bad-putt', 'loop-putt',
          'swing-putt', 'look-putt', 'lookloop-putt'],
    '9': ['push'],
    'custom': ['lookLR', 'fingerDip', 'into-fingerDip', 'scream', 'shake-head',
               'leftSit', 'into-leftSit', 'short-tease'],
}

COLORS = [
    (1.0, 1.0, 1.0),
    (0.96875, 0.691406, 0.699219),
    (0.933594, 0.265625, 0.28125),
    (0.863281, 0.40625, 0.417969),
    (0.710938, 0.234375, 0.4375),
    (0.570312, 0.449219, 0.164062),
    (0.640625, 0.355469, 0.269531),
    (0.996094, 0.695312, 0.511719),
    (0.832031, 0.5, 0.296875),
    (0.992188, 0.480469, 0.167969),
    (0.996094, 0.898438, 0.320312),
    (0.996094, 0.957031, 0.597656),
    (0.855469, 0.933594, 0.492188),
    (0.550781, 0.824219, 0.324219),
    (0.242188, 0.742188, 0.515625),
    (0.304688, 0.96875, 0.402344),
    (0.433594, 0.90625, 0.835938),
    (0.347656, 0.820312, 0.953125),
    (0.191406, 0.5625, 0.773438),
    (0.558594, 0.589844, 0.875),
    (0.285156, 0.328125, 0.726562),
    (0.460938, 0.378906, 0.824219),
    (0.546875, 0.28125, 0.75),
    (0.726562, 0.472656, 0.859375),
    (0.898438, 0.617188, 0.90625),
    (0.7, 0.7, 0.8),
    (0.3, 0.3, 0.35),
    (0.22, 0.55, 0.94),
    (1, .25, .420),
    (0.89019, 0.43921, 0.69803),
    (0.74117, 0.87450, 0.95686),
    (0.63921, 0.85882, 0.67450),
    (0.03921, 0.86274, 0.65490),
    (0.19607, 0.72549, 0.71372),
    (0.98431, 0.53725, 0.39607),
    (0.96862, 0.74901, 0.34901),
    (0.65882, 0.17647, 0.25882),
    (0.41176, 0.64313, 0.28235),
    (0.32549, 0.40784, 0.6),
    (0.933594, 0.265625, 0.28125),
]
...
SHIRTS_TEX = [
    ...
    'phase_4/maps/ttoff_t_chr_avt_shirt_bossbotCrusher.jpg',
    'phase_4/maps/ttoff_t_chr_avt_shirt_lawbotCrusher.jpg',
    None,
    None,
    None,
    None,
...
SLEEVES_TEX = [
    ...
    'phase_4/maps/ttoff_t_chr_avt_shirtSleeve_bossbotCrusher.jpg',
    'phase_4/maps/ttoff_t_chr_avt_shirtSleeve_lawbotCrusher.jpg',
    None,
    None,
    None,
    None,
...
SHORTS_TEX = [
    ...
    'phase_4/maps/ttoff_t_chr_avt_shorts_bossbotCrusher.jpg',
    'phase_4/maps/ttoff_t_chr_avt_shorts_lawbotCrusher.jpg',
    None,
    None,
    None,
    None,
